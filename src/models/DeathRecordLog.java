...
public class DeathRecordLog extends javax.swing.JFrame {

    DBConnectionHelper db1 = new DBConnectionHelper();

    public DeathRecordLog() {
        initComponents();
        ...
        String columnNames[] = {"Date", "Pre Quantity", "Dead", "Current Quantity", "Added by"};
    ...
    private void initComponents() {
        ...
        jLabel27.setText("Death Record log");
    ...
    private void stocknumberComboActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_stocknumberComboActionPerformed
        ...
        ArrayList<DeathRecord> record;
        record = db.getDeathRecordLog(StockNo);
        for (DeathRecord allrecord : record) { 
            model.addRow(new Object[]{
                allrecord.getDate(),
                allrecord.getPreQuantity(),
                allrecord.getDead(),
                allrecord.getCurrentQuantity(),
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(DeathRecordLog.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new DeathRecordLog().setVisible(true);
            }
        });
    }
